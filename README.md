...
This project trains an agent to move a double-jointed arm to target locations, building on code provided by Udacity's [Deep Reinforcement Learning Nanodegree](https://www.udacity.com/course/deep-reinforcement-learning-nanodegree--nd893) to solve the Unity Reacher environment.
...
There are two versions of the Unity Reacher environment, one with a single agent and one with 20. This implementation uses the environment with 20 agents.

The solution for the multiple agent environment is an average score of +30 (over 100 consecutive episodes, and over all agents).  Specifically,
...
To read more about this implementation, see Report.md in this repository.
